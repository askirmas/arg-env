...
| **Dockerfile** | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - |  |  | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - |
| **Dockerfile.injected** | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - | - |  |  |  |  | direct | 'single' | "double" | backtick | $'bash' | abc def | Lowercase | 2 | #commented | comment#ed | comment #ed | commented | comment | ' | "\"" | 1; SPEC_WEIRD_ONELINE_2=1 | 1 SPEC_WEIRD_ONELINE_4=1 | $(echo 1) | space | tab | dash1 | ld1 | ld2 | digit | SPEC_WEIRD_LEADING_EQ_2=leadEq2 | - | : | @ | == | assigned | $$DOLLAR | $$SPEC_REUSE_ASSIGNED | $SPEC_REUSE_ASSIGNED | '$SPEC_REUSE_ASSIGNED' | "$SPEC_REUSE_ASSIGNED" | ${SPEC_REUSE_ASSIGNED} | '${SPEC_REUSE_ASSIGNED} is ${SPEC_REUSE_ASSIGNED}' | '${X} is not ${SPEC_REUSE_ASSIGNED}' | "${SPEC_REUSE_ASSIGNED} is ${SPEC_REUSE_ASSIGNED}" | "${X} is not ${SPEC_REUSE_ASSIGNED}" | ${SPEC_REUSE_ASSIGNED:-def} | ${SPEC_REUSE_ASSIGNED-def} | ${X:-${SPEC_REUSE_ASSIGNED}} | ${X-${SPEC_REUSE_ASSIGNED}} | ${SPEC_REUSE_ASSIGNED?def} | ${SPEC_REUSE_ASSIGNED:?def} | ${X:?${SPEC_REUSE_ASSIGNED}} | ${X?${SPEC_REUSE_ASSIGNED}} | SPEC_REUSE_ASSIGNED | ${!SPEC_META_} | $${!SPEC_META_} | ${${SPEC_META_}} | " unq | - | - | - | - |
...
| - | **docker-compose.yml** | **docker.env** | **Dockerfile** | **Dockerfile.injected** | **shell.env** | **shell.sh** |
| - | - | - | - | - | - | - |
| **version: "3.8"=** |  | - | - | - | - | - |
| **services:=** |  | - | - | - | - | - |
| **SPEC_VALUE_=** | - |  | - | - |  | - |
